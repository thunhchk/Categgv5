...
local Tabs = {
  Main = Window:AddTab({Title = "chính", Icon = "rbxassetid://71929667640689"}),
  Settings = Window:AddTab({Title = "cài đặt", Icon = "rbxassetid://71929667640689"}),
  Melee = Window:AddTab({Title = "lấy melee v2", Icon = "rbxassetid://71929667640689"}),
  Quests = Window:AddTab({Title = "lấy item", Icon = "rbxassetid://71929667640689"}),
  SeaEvent = Window:AddTab({Title = "biển", Icon = "rbxassetid://71929667640689"}),
  Mirage = Window:AddTab({Title = "tộc v4", Icon = "rbxassetid://71929667640689"}),
  Drago = Window:AddTab({Title = "Drago Dojo", Icon = "rbxassetid://71929667640689"}),
  Prehistoric = Window:AddTab({Title = "Prehistoric", Icon = "rbxassetid://71929667640689"}),
  Raids = Window:AddTab({Title = "tập kích", Icon = "rbxassetid://71929667640689"}),
  Combat = Window:AddTab({Title = "pvp", Icon = "rbxassetid://71929667640689"}),
  Travel = Window:AddTab({Title = "dịch chuyển", Icon = "rbxassetid://71929667640689"}),
  Fruit = Window:AddTab({Title = "trái cây blox", Icon = "rbxassetid://71929667640689"}),
  Shop = Window:AddTab({Title = "cửa hàng tiktok", Icon = "rbxassetid://71929667640689"}),
  Misc = Window:AddTab({Title = "linh tinh", Icon = "rbxassetid://71929667640689"})
}
...
Tabs.Main:AddSection("cat egg v5 on top")
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "cày cấp", Description = "farm tới level 2750", Default = false})
...
local Initialize = Tabs.Settings:AddToggle("Initialize", {Title = "un bản cho ae đánh không được", Description = "[ đừng tắt nhé ]", Default = true})
